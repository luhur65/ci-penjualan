...
<script>
  ...
  let sortname = 'nama';
  let sortorder = 'asc';
  const GRID_PREF_KEY = 'alatbayar_master_grid';
  const urlMaster = '/alatbayar';
  const masterGrid = '#jqGrid';
  const gridPager = '#jqGridPager';

  const accessRights = {
    add: <?= has_permission('alatbayar', 'create') ? 'true' : 'false' ?>,
    edit: <?= has_permission('alatbayar', 'update') ? 'true' : 'false' ?>,
    delete: <?= has_permission('alatbayar', 'delete') ? 'true' : 'false' ?>,
    report: <?= has_permission('alatbayar', 'report') ? 'true' : 'false' ?>,
    export: <?= has_permission('alatbayar', 'export') ? 'true' : 'false' ?>,
  };
