...
<script>
  ...
  $(document).ready(async function() {
    ...
    apiUrlParameterAll = `${API_URL}/parameters`;
    apiUrlParameter = `${API_URL}/parameter/lookup`;

    postDataParameterAll = {
      isLookup: true,
      tipeData: 'LOCAL'
    }
    ...
    request = [{
      url: apiUrlParameterAll,
      postData: postDataParameterAll
    }, {
      url: apiUrlParameter,
      postData: postDataParameter
    }, ]

    fetchMultipleData(request)
      .then(([resultParameterAllLookup, resultParameterLookup]) => {
        parameterAllLookupType = resultParameterAllLookup.typedata
        parameterAllLookupData = resultParameterAllLookup.data

        parameterLookupType = resultParameterLookup.typedata
        parameterLookupData = resultParameterLookup.data
      })
      .catch((error) => {
