...
<body class="hold-transition sidebar-collapse layout-fixed">
  ...
  <!-- Custom JS -->
  <script src="<?= base_url('public/libraries/js/HttpManager.js?version=' . config('App')->version) ?>"></script>
  <script src="<?= base_url('public/libraries/js/UIManager.js?version=' . config('App')->version) ?>"></script>
  <script src="<?= base_url('public/libraries/js/JqGridLazyLoader.js?version=' . config('App')->version) ?>"></script>
  <script src="<?= base_url('public/libraries/js/JqGridManager.js?version=' . config('App')->version) ?>"></script>
